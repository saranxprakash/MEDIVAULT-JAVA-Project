...
public class Appointment implements Serializable {
    ...
    private String appointmentID,patientID,patient_name,doctorID,doctor_name;
    ...
    public void   setPatientName(String n)        { this.patient_name= n; }

    public String getDoctorId()                   { return doctorID; }
    public void   setDoctorId(String id)          { this.doctorID= id; }

    public String getDoctorName()                 { return doctor_name; }
    public void   setDoctorName(String n)         { this.doctor_name = n; }
    ...
    // Helper: combines date + time into one key, used to check conflicts
    ...
    public String toString(){
        return "Appointment{" + appointmentID + ", patient=" + patient_name
                + ", doctor=" + doctor_name + ", " + date + " " + time + "}";
    }
